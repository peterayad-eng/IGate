<main>
    <?php
        $updatedid = $_GET['id'];
        $select_sql = "SELECT * FROM carousel WHERE id = '{$updatedid}'";
    ...
    <div id="services">
        ...
        <div class="animated fadeIn">
           <div class="login-form">
                ...
                <form  action="CarouselAfterEditData.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row col-12 nopadd">
                        ...
                        <div class="col-10 nopadd middlevertical"><input type="text" class="form-control" placeholder="Enter English Slide Label" name="caption" value="<?=$row['caption']?>" required></div>
                    </div>
                    <div class="form-group row col-12 nopadd">
                        <div class="col-2 labelCenter middlevertical"><label>Arabic Label</label></div>
                        <div class="col-10 nopadd middlevertical"><input type="text" class="form-control" placeholder="Enter Arabic Slide Label" name="caption_ar" value="<?=$row['caption_ar']?>" required></div>
                    </div>
